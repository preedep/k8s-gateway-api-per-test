...
info "Labeling namespace ${APP_NS} for ambient mode..."
kubectl label namespace "${APP_NS}" istio.io/dataplane-mode=ambient --overwrite
...
GW_NAME="istio-ambient-gw-rust"

info "Creating Istio Gateway API resources in namespace ${APP_NS} for Rust service (Ambient mode)"
...
info "Ambient mode enabled for namespace: ${APP_NS}"
info "OK"
